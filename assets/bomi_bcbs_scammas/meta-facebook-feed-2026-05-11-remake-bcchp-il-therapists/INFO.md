...
- Old campaign: `120247750689930170` - `DELETED`
- Old ad set: `120247750691660170` - `DELETED`
- Old ad: `120247750713680170` - `DELETED`
...
- Creative `1323556353061976` readback included `image_hash=71030145b6872b0bcd12b58476d9ea73`.
- Ad account image lookup returned stored asset name `Bomi Health Digital Ad - Meta Facebook Ad - 1080x1080.png`.
- Meta returned valid `DESKTOP_FEED_STANDARD` and `MOBILE_FEED_STANDARD` preview iframe bodies for ad `120247752456360170`.
...
- `588675787671641_122188261442865755`
